...
### 合并前协议(2026-09-04,一次 preview 变红之后加的)
...
### T1.2.2 一键 bootstrap 部署脚本(测试网实跑)  `DONE`
- **优先级**:high
